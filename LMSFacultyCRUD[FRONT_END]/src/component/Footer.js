...
const Footer = () => {
  return (
    <>
      <footer className='text-center text-lg-start text-muted footer' style={{backgroundColor:'#003060'}}>
        <section className='d-flex justify-content-center justify-content-lg-between p-4 border-bottom footer'>
          <div className='me-5 d-none d-lg-block footer' style={{color:'white'}}>
