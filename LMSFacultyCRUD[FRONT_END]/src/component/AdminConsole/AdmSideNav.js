...
function AdmSideNav() {
  ...
  return (
    <div className={`sidebar d-flex flex-column justify-content-between bg-dark text-white p-4 ${isSidebarVisible ? 'visible' : 'hidden'}`} style={{ height: '100vh',width:'100%' }}>

        <h3 className="d-flex align-items-center text-white"> {/* onClick={toggleSidebar}  */} 
        ...
        <ul className="nav-items p-0 text-start">
          <Link to="M2" className="nav-link text-white">
            ...
            {isSidebarVisible && <span className="fs-5">Student Management</span>}
          </Link>
        </ul>
          ...
          <ul className="nav-items p-0 text-start">
            <Link to="M3" className="nav-link text-white">
              ...
              {isSidebarVisible && <span className="fs-5">Faculty Management</span>}
            </Link>
            </ul>
          <ul className="nav-items p-0 text-start">
